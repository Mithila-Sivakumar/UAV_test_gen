...
def arg_parse():
    ...
    # adding an additional argument num for the number of obstacles
    parser.add_argument(
        "num",
        type=int,
        help="the number of obstacles to be placed (max=3)",
    )
...
if __name__ == "__main__":
    ...
    try:
        args = arg_parse()
        generator = TestGenerator(case_study_file=args.test)
        test_cases = generator.generate(args.budget, args.num)
